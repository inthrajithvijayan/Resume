          ...
          while ($row=mysqli_fetch_assoc($result))
           {
            ...
            <td>'.$CITY.'</td>
            <td>
            <button class="btn-primary"><a href="empdataupt.php? updateid='.$id.'" class="text-light">Update</a></button>
   ...
   if($page>1)
    {
      ...
      echo "<a class='btn btn-primary' href='empdatapgn.php?page=".($page - 1)."'> Previous </a>";
        ...
        // echo "<button><a EMP_INFORMATIONindex.php?page=".($page - 1)."'>Previous</a></button>";
    }
